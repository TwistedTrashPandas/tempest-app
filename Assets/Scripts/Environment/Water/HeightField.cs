...
public class HeightField : MonoBehaviour
{
    ...
    public void Initialize(Vector3 midPosition)
    {
        ...
        inOutCounter = 0;
        currentCollision = 1;
        transform.position = midPosition - new Vector3(width*quadSize/2f,midPosition.y, depth * quadSize / 2f);
    }
    ...
    private void initBuffers()
    {
        ...
        normalsCB = new ComputeBuffer(width * depth, 12);
        ...
        material.SetInt("g_iDepth", depth);
        material.SetInt("g_iWidth", width);
